        ...
        <div class="content-wrapper">
            ...
            <div class="header">
                <div class="header-left">
                    <h2>Contactos</h2>
                    <p>Comunícate directamente con los usuarios de tu organización</p>
                </div>
...
<style>
    ...
    .contact-card {
        ...
        align-items: center;
        gap: 12px;
        box-shadow: 0 2px 12px rgba(10,61,107,0.05);
...
<script>
    ...
    buscador.addEventListener('input', function () {
        ...
        cards.forEach(card => {
            ...
            const match    = nombre.includes(q) || codigo.includes(q) || telefono.includes(q);
