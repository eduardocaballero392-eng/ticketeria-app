    ...
    <main class="main-content">
        <div class="content-wrapper">
            ...
            <div class="profile-container">
                <form class="glass-form" id="perfil-form" method="POST" action="{{ route('usuario.update') }}">
                    @csrf
                    ...
                    <div class="form-grid">
                        <div class="input-group">
                            <label>Código de Usuario <small>(No editable)</small></label>
                            <input type="text" value="{{ $usuario->codigo_usuario }}" class="input-readonly" readonly>
                        </div>

                        <div class="input-group">
                            <label>DNI <small>(No editable)</small></label>
                            <input type="text" value="{{ $usuario->dni }}" class="input-readonly" readonly>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $usuario->activo ? 'Activo' : 'Inactivo' }}" class="input-readonly" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="input-group">
                            ...
                            <input type="email" name="correo" value="{{ $usuario->correo }}" class="input-readonly" readonly>
                        </div>

                        <div class="input-group-phone">
                            <label>Teléfono</label>
                            <div class="phone-container">
                                <input type="text" name="codigo_pais" value="{{ $usuario->codigo_pais }}" style="width: 60px; text-align: center;" placeholder="+51" required>
                                <input type="text" name="telefono" value="{{ old('telefono', $usuario->telefono) }}" style="flex: 1;" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-footer">
                        ...
                        <div class="btn-actions">
                            <a href="{{ route('usuario.datos') }}" class="btn-discard">Descartar</a>
