...
<aside id="jhs-sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a href="{{ route('cliente.tickets') }}"
       class="sb-nav-item {{ Route::is('cliente.tickets') ? 'active' : '' }}">
      <span class="sb-nav-icon"><i class="fa-solid fa-ticket"></i></span>
      <span class="sb-nav-text">Mis Tickets</span>
      {{-- @if(!empty($ticketsPendientes) && $ticketsPendientes > 0)
        <span class="sb-badge">{{ $ticketsPendientes }}</span>
      @endif --}}
      <span class="sb-tooltip">Mis Tickets</span>
    </a>

    <a href="{{ route('cliente.contactos') }}"
      class="sb-nav-item {{ Route::is('cliente.contactos') ? 'active' : '' }}">
