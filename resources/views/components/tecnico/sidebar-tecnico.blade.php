...
<aside id="jhs-sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a href="{{ route('tecnico.datos') }}"
       class="sb-nav-item {{ Route::is('tecnico.datos') ? 'active' : '' }}">
    ...
    <a href="{{ route('tecnico.dashboard') }}"
        class="sb-nav-item {{ Route::is('tecnico.dashboard') ? 'active' : '' }}">
    ...
    <a href="{{ route('tecnico.mistickets') }}"
        class="sb-nav-item {{ Route::is('tecnico.mistickets') ? 'active' : '' }}">
    ...
    <a href="{{ route('tecnico.contactos') }}"
      class="sb-nav-item {{ Route::is('tecnico.contactos') ? 'active' : '' }}">
